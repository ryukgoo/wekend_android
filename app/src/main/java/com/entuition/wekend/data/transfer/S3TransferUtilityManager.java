package com.entuition.wekend.data.transfer;
...
public class S3TransferUtilityManager {
    ...
    public void beginDownload(Context context, String key) {
        ...
        TransferObserver observer = transferUtility.download(ImageUtils.PROFILE_IMAGE_BUCKET_NAME, key, file);
    ...
    public void beginUpload(Context context, String filePath, String newFilename) {
        ...
        try {
            ...
            TransferObserver observer = transferUtility.upload(ImageUtils.PROFILE_IMAGE_BUCKET_NAME, newFilename, file);
            observers.add(observer);
