...
public class UserInfo {
    ...
    public static class Index {
        ...
        public static final String PHONE_REGISTERED_TIME = "phone-registered_time-index";
    }
    ...
    static class Attribute {
        ...
        static final String EXPIRES_TIME = "ExpiresTime";
    }
    ...
    public UserInfo(UserInfo origin) {
        ...
        this.purchaseTime = origin.purchaseTime;
        this.expiresTime = origin.expiresTime;
    }
    ...
    @DynamoDBIndexRangeKey(globalSecondaryIndexName = Index.PHONE_REGISTERED_TIME)
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = Index.PHONE_REGISTERED_TIME)
    ...
    @DynamoDBAttribute(attributeName = Attribute.PURCHASE_TIME)
    ...
    @DynamoDBAttribute(attributeName = Attribute.EXPIRES_TIME)
