...
interface IInAppBillingService {
     ...
     * @param apiVersion billing API version that the app is using
     * @param packageName the package name of the calling app
     * @param type of the in-app items ("inapp" for one-time items
     *        and "subs" for subscriptions)
     ...
     * @param type of the in-app item being purchased ("inapp" for one-time items
     *        and "subs" for subscriptions)
     ...
     * has completed, the handleActivityResult() will give a resultCode of OK or CANCELED.
     ...
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param type of the in-app items being requested ("inapp" for one-time items
     *        and "subs" for subscriptions)
